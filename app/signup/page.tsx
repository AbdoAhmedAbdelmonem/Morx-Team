...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary/30 relative overflow-hidden font-sans">
      ...
      >
        <div className="absolute top-[-10%] left-[-10%] size-[600px] bg-primary/10 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-10%] size-[600px] bg-secondary/10 rounded-full blur-[120px] animate-pulse delay-700" />
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 0 && (
            ...
            >
              ...
              <p className="text-xl text-neutral-400 font-medium">Your workflow isn&apos;t just about tasks — it&apos;s about the marks you leave. Ready to build something great?</p>
              <Button 
                onClick={() => setStep(1)}
                className="h-16 px-12 rounded-full text-xl font-black italic tracking-tighter bg-white text-black hover:scale-105 transition-transform"
              >
          ...
          {step === 1 && (
            ...
            >
              <div className="space-y-4 text-center">
                ...
                <p className="text-lg text-neutral-500">We exclusively use Google Auth for maximum security and simplicity.</p>
              </div>
              ...
              <div className="grid gap-4">
                 <button 
                  ...
                  disabled={loading}
                  className="flex items-center justify-between group p-8 rounded-[40px] bg-white text-black hover:scale-[1.02] transition-all text-left shadow-[0_20px_40px_-15px_rgba(255,255,255,0.1)]"
                 >
                    <div className="flex items-center gap-6">
                       <div className="size-14 rounded-2xl bg-white flex items-center justify-center p-3 shadow-sm">
                       ...
                       <div>
                          <p className="text-2xl font-black text-black italic tracking-tighter">Launch with Google</p>
                          <p className="text-sm font-bold text-black/40">Instant Authentication</p>
                       </div>
                    </div>
                    {loading ? <Loader2 className="animate-spin size-8" /> : <ChevronRight className="size-8 text-black/20 group-hover:text-black transition-colors" />}
                 </button>
              ...
              <div className="pt-8 flex flex-col items-center gap-4">
                 <p className="text-neutral-600 text-[10px] font-black uppercase tracking-[0.3em]">Already initialized?</p>
                 <Link href="/signin" className="text-white hover:text-primary font-bold underline underline-offset-8 decoration-white/20 hover:decoration-primary transition-all">Sign in to your account</Link>
              </div>
            </motion.div>
          )}
